          ...
          <div className='text-center mb-24'>
            ...
            <div className='flex flex-wrap justify-center gap-4 mt-10'>
              <motion.button
                ...
                className='bg-black text-white px-10 py-3 rounded-full hover:opacity-90
              ...
              <motion.button
                ...
                whileTap={{ opacity: 1, scale: 0.95 }}
                transition={{ duration: 0.3 }}
                className='border border-gray-400 px-10 py-3 rounded-full hover:bg-gray-200
              transiton-all cursor-pointer'
              >
                View History
              </motion.button>
            </div>
              ...
              [
                ...
                justify-center shadow-lg'>
                  ...
                  <div className='pt-10 text-center'>
                    <div className='text-sm text-green-500 font-semibold mb-2 tracking-wide'>
                      {item.step}
                    </div>
                  ...
                  >
                    <div className='flex flex-col md:flex-row items-center gap-8'>
                      ...
                      <div className='w-full max-w-1/2'>
                        <div className='bg-green-50 text-green-600 w-12 h-12 rounded-xl
